...
const About = (props) => {
  return (
    <Box sx={{m: 2}} style={{display:'flex',justifyContent:'space-evenly' }}>
      <div>
        <h1>Oren Ovadia</h1>
        <p style={{ fontSize: "1.5rem" }}>Full Stack Developer<br/>Trainer<br/>Motorcyclist<br/>Photographer</p>
      </div>
      <img src={image} alt="profile" width={'500px'} style={{border:'5px black solid', borderRadius:'250px'}} />
      <div style={{width: '25vh', fontSize:'1.1rem'}}>
      My name is Oren and I recently completed a fullstack JavaScript course. <br/>
